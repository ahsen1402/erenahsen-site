...
3. [Modeling combination therapies in patient cohorts and cell cultures using correlated drug action](https://www.cell.com/). AS Arun, SC Kim, Ahsen ME, Gustavo Stolovitzky. (2024), *iScience*.
4. [A primer on the use of machine learning to distil knowledge from data in biological psychiatry](https://www.nature.com/). Thomas P Quinn, (13 Authors), Ahsen ME, Stephen J Glatt. (2024), *Molecular Psychiatry*.
5. [The societal impact of sharing economy platform self-regulations—An empirical investigation](https://pubsonline.informs.org/). Wencui Han, Xunyi Wang, Ahsen ME, Sunil Wattal. (2022), *Information Systems Research*.
6. [External validation of an ensemble model for automated mammography interpretation by artificial intelligence](https://jamanetwork.com/). William Hsu, (5 Authors), Ahsen ME, CI Lee. (2022), *JAMA Network Open*.
7. [Unannotated small RNA clusters associated with circulating extracellular vesicles detect early stage liver cancer](https://scholar.google.com/). Johann Von Felden, (3 Authors), Ahsen ME, Augusto Villanueva. (2022), *Gut*.
8. [The Fermi–Dirac distribution provides a calibrated probabilistic output for binary classifiers](https://scholar.google.com/). SC Kim, AS Arun, Ahsen ME, Robert Vogel, Gustavo Stolovitzky. (2021). *PNAS*.
9. [A community challenge to evaluate RNA-seq, fusion detection, and isoform quantification methods for cancer discovery](https://www.cell.com/). Creason Allison, (20 Authors), Ahsen ME, Kyle Ellrott. (2021). *Cell Systems*.
10. [Transcriptomic characterization of cancer-testis antigens identifies MAGEA3 as a driver of tumor progression in hepatocellular carcinoma](https://journals.plos.org/). Craig AJ, (7 Authors), Ahsen ME, Augusto Villanueva. (2021). *PLOS Genetics*.
11. [Effect of AI explanations on human perceptions of patient-facing AI-powered healthcare systems](https://link.springer.com/), Zhang Z, Genc Y, Wang D, Ahsen ME, Fan X. (2021) *Journal of Medical Systems*.
12. R/PY-SUMMA: A R/Python Package for Unsupervised Ensemble Learning for Binary Classification Problems in Bioinformatics. Ahsen, M. E., Vogel, R., & Stolovitzky, G. A. (2020). *Journal of Computational Biology*.
...
19. NeTFactor, a framework for identifying transcriptional regulators of gene expression-based biomarkers. Ahsen, ME, Chun, Y., Grishin, A., Grishina, G., Stolovitzky, G., Pandey, G., & Bunyavanich, S. (2019). *Scientific Reports*, 9(1), 12970-12970.
20. Inferring Genome-Wide Interaction Networks Using the Phi-Mixing Coefficient, and Applications to Lung and Breast Cancer, Singh N, Ahsen ME, et al., *IEEE Transactions on Molecular, Biological and Multiscale Communications* (2019).
...
35. Timing the Use of Breast Cancer Risk Information in Biopsy Decision Making, Ayvaci MUS, Ahsen ME, Raghunathan S, Gharibi Z, *Production and Operations Management*, 26 (7), 1333-1358 (2017).
36. Estimating Waiting Time for Deceased Donor Renal Transplantation in the Era of New Kidney Allocation System, Furkan Torlak, Mehmet U.S. Ayvaci, Ahsen ME et al., *Transplantation Proceedings* (2016).
...
38. Optimized Prediction of Extreme Treatment Outcomes in Ovarian Cancer, Burook Misganaw, Ahsen ME et al., *Cancer Informatics* (2015).
